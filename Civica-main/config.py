...
class Settings:
    ...
    text_model: str = os.getenv("CIVICA_TEXT_MODEL", "gemini-2.5-flash")
    multimodal_model: str = os.getenv("CIVICA_MULTIMODAL_MODEL", "gemini-2.5-flash")
    chat_model: str = os.getenv("CIVICA_CHAT_MODEL", "gemini-2.5-flash")
